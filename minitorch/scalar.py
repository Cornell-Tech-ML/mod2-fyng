...
class Scalar:
    ...
    def log(self) -> Scalar:
        """Applies the natural logarithm to this Scalar."""
        return Log.apply(self)

    def exp(self) -> Scalar:
        """Applies the exponential function to this Scalar."""
    ...
    def chain_rule(self, d_output: Any) -> Iterable[Tuple[Variable, Any]]:
        """Apply the to a Scalar value.

        Args:
        ----
            d_output (Any): output value of the scalar function.

        Returns:
        -------
            Iterable[Tuple[Variable, Any]]: List of tuples input variables to `h.last_fn` and their derivatives.
